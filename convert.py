...
def do_avatars():
    folders = [
        ('./res/export/assets/game/11_im/bundleassets/avatars',
         './res/converted/images/imavatars'),
        ('./res/export/assets/game/15_os/bundleassets/osavatars',
            './res/converted/images/osavatars')
    ]
...
def do_music():
    folders = [
        ('./res/export/assets/game/15_os/bundleassets/osbgms',
         './res/converted/audios/bgms'),
        ('./res/export/assets/game/15_os/bundleassets/ossounds',
            './res/converted/audios/sounds'),
